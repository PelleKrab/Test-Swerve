...
public class SlowDrive extends CommandBase {
    ...
    public void execute() {
        ...
        xSpeed = -m_xspeedLimiter.calculate(driverController.getLeftY()) * 0.5;
        ySpeed = -m_yspeedLimiter.calculate(driverController.getLeftX()) * 0.5;
        rot = m_rotLimiter.calculate(driverController.getRightX()) * 0.5;
